...
-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('OWNER', 'TEAM_LEAD', 'DEVELOPER', 'VIEWER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_COMMENTED', 'PROJECT_MEMBER_ADDED', 'PROJECT_MEMBER_REMOVED', 'NEW_MESSAGE', 'TEAM_MEMBER_JOINED', 'MENTION');
